...
export class UnitOfWorkComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.text1 = `public class CustomerRepository
{
  ...
  public void SaveChanges()
  {
    ...
    this.text2 = `public class UnitOfWork
{
  ...
  public void Save()
  {
    ...
    this.text3 = `public class CustomersRepository
{
  private Entities _entities;
  ...
  public void SaveChanges()
  {
    ...
    this.text4 = `public ContactsController()
{
