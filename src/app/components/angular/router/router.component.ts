...
export class AppRoutingModule {}`;
  ...
  },
  {
    ...
    this.text4 = `<ul class="nav nav-pills card-header-pills">
<li class="nav-item">
...
<router-outlet></router-outlet>`;
    this.text5 = `const Articles: Article[] = [
  {
    id: "1",
    slug: "bai-viet-1",
    title: "Bai viet 1",
...
export class ArticleService {
  getArticles(): Observable<Article[]> {
    ...
    this.text6 = `export class ArticleListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.text7 = `<div class="row" *ngIf="articles$ | async as articles">
<div class="col-md-3" *ngFor="let article of articles">
  ...
  },
  {
    ...
    this.text9 = `export class ArticleDetailComponent implements OnInit {
