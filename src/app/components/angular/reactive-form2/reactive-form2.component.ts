...
export class ReactiveForm2Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.text1 = `export class SignInRfComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.text2 = `<form class="sign-in-form" [formGroup]="signInForm">
<h2>Sign in</h2>
...
<pre>{{ signInForm.value | json }}</pre>
    ...
    this.text3 = `let control = new FormControl("", Validators.required);
//Or
this.fb.control("", Validators.required);`;
    this.text4 = `isUserNameDuplicated(control: AbstractControl): Observable<ValidationErrors> {
  return of(null);
}
...
this.fb.control("", Validators.required, this.isUserNameDuplicated);`;
  ...
  static composeAsync(validators: AsyncValidatorFn[]): AsyncValidatorFn | null;
    ...
    this.text6 = `this.signInForm = this.fb.group({
  username: [
    "",
    Validators.compose([
      Validators.required,
    ...
    this.text7 = `import { AbstractControl, ValidatorFn } from "@angular/forms";
...
export function NoWhitespaceValidator(): ValidatorFn {
  return (control: AbstractControl): { [key: string]: any } => {
    ...
    this.text8 = `export class SignInRfComponent implements OnInit {
  signInForm: FormGroup;
  constructor(private fb: FormBuilder) {}
...
C`;
    this.text9 = `this.signInForm = this.fb.group({
  username: [
    "",
    Validators.compose([
      //Validators.required,
