...
export class NgrxEffectsLifecycleComponent implements OnInit {
  text1 = `init$ = createEffect(() =>
  this.actions$.pipe(
    ofType(ROOT_EFFECTS_INIT),
    map(action => ...)
  )
);`
  text2 = `import { Injectable } from '@angular/core';
...
export class LogEffects {
  ...
  text3 = `import { Injectable } from '@angular/core';
...
export class AuthEffects {
  ...
  text4 = `import { ErrorHandler, NgModule } from '@angular/core';
...
@NgModule({
  ...
  text5 = `class UserEffects implements OnInitEffects {
  ngrxOnInitEffects(): Action {
    return { type: '[UserEffects]: Init' };
  }
}`
  text6 = `import { Injectable } from '@angular/core';
...
export class UserEffects implements OnRunEffects {
  ...
  text7 = `class EffectWithIdentifier implements OnIdentifyEffects {
