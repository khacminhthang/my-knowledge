...
export class DynamicComponentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.text1 = `<button (click)="addDynamicCompOne()" class="btn">
...
export class ExampleContainerComponent implements OnInit {
  ...
  addDynamicCompTwo() {
    ...
    this.text3 = `const componentFactory = this.cfr.resolveComponentFactory(
  DynamicContentOneComponent
);`;
    this.text4 = `const componentRef = this.containerRef.createComponent(componentFactory);`;
    this.text5 = `@NgModule({
  declarations: [
    AppComponent,
  ...
  entryComponents: [DynamicContentOneComponent, DynamicContentTwoComponent],
    ...
    this.text6 = `<button (click)="clearDynamicComp()" class="btn">Clear</button>
...
<p>++++++{{data}}+++++++++</p>`;
  ...
  componentRef.instance.data = "INPUT DATA 1";
    ...
    this.text9 = `async addDynamicCompOne() {
...
async addDynamicCompTwo() {
  ...
  componentRef.instance.data = "INPUT DATA 2";
    ...
    this.text10 = `import { BrowserModule } from "@angular/platform-browser";
