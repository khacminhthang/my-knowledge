...
export class TemplateDrivenForm2Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.text1 = `<div class="container">
...
name="username">`;
    this.text3 = `export class SignInComponent {
...
<pre>{{ username.errors | json }}</pre>`;
    this.text5 = `<mat-form-field appearance="outline">
<mat-label>Username</mat-label>
<input
  matInput
  placeholder="Username"
...
<mat-error *ngIf="username.errors.required">Username is required!</mat-error>
    ...
    this.text6 = `<mat-form-field appearance="outline">
<mat-label>Username</mat-label>
<input
  matInput
  placeholder="Username"
...
<mat-error *ngIf="username.errors?.required">Username is required!</mat-error>
    ...
    this.text7 = `<mat-error *ngIf="username.touched && !username.valid">
...
<span *ngIf="!(username.errors.minlength || username.errors.maxlength) && username.errors.pattern">Only alphabet</span>
    ...
    this.text8 = `<mat-form-field appearance="outline">
<mat-label>Password</mat-label>
<input
  type="password"
  matInput
