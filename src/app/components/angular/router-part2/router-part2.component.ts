...
export class RouterPart2Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.text1 = `import { NgModule } from '@angular/core';
...
export class ArticleModule { }`;
    this.text2 = `import { NgModule } from '@angular/core';
import { CommonModule } from '@angular/common';
...
export class ArticleModule { }`;
    this.text3 = `import { ArticleModule } from './article/article.module';
...
export class AppModule { }`;
    this.text4 = `const routes: Routes = [
  {
    path: '',
    redirectTo: 'article',
    pathMatch: 'full'
    ...
    this.text5 = `const routes: Routes = [
  {
    path: 'article',
    component: ArticleListComponent
  },
...
export class ArticleRoutingModule { }`;
    this.text6 = `import { ArticleRoutingModule } from './article-routing.module';
...
export class ArticleModule { }`;
    this.text7 = `const routes: Routes = [
  {
    path: 'article',
    component: ArticleListComponent
  },
    ...
    this.text8 = `const routes: Routes = [
  {
    ...
    this.text9 = `const routes: Routes = [
  {
    path: 'article',
    ...
    this.text10 = `export class ArticleDetailComponent implements OnInit {
...
*/`;
    this.text11 = `export class ArticleDetailComponent implements OnInit {
  article$: Observable<Article>;
  constructor(private _route: ActivatedRoute, private _api: ArticleService) {}
  ...
  ngOnInit(): void {
    ...
    this.text12 = `queryParamMap.subscribe(query => {
  console.log(query.get('sort'));
})`;
    this.text13 = `navigateByUrl(url: string | UrlTree, extras: NavigationExtras = { skipLocationChange: false }): Promise<boolean>;
navigate(commands: any[], extras: NavigationExtras = { skipLocationChange: false }): Promise<boolean>;`;
    this.text14 = `class SomeComponent {
  ...
  onClick() {
    ...
    this.text15 = `this.router.events.pipe(
