...
<form class="sign-in-form">
  ...
  <div class="row-control row-actions">
    ...
    this.text4 = `import { ReactiveFormsModule } from "@angular/forms";
...
export class AppModule {}`;
    this.text5 = `export class SignInRfComponent implements OnInit {
  ...
  ngOnInit(): void {}
    ...
    this.text6 = `<form class="sign-in-form" [formGroup]="signInForm"></form>`;
    this.text7 = `<form class="sign-in-form" [formGroup]="signInForm">
<h2>Sign in</h2>
<div class="row-control">
  <mat-form-field appearance="outline">
    <mat-label>Username</mat-label>
