...
export class NgrxStoreFetureCreatorsComponent implements OnInit {
  ...
  text1 = `import { createFeature, createReducer, on } from '@ngrx/store';
...
export const selectBookListPageViewModel = createSelector(
  ...
  text3 = `import { createFeature, createReducer, on } from '@ngrx/store';
import { Book } from './book.model';
...
export const booksFeature = createFeature({
  ...
  text4 = `import { createFeature, createReducer, on } from '@ngrx/store';
import { Book } from './book.model';
...
bootstrapApplication(AppComponent, {
  ...
  text7 = `import { Route } from '@angular/router';
