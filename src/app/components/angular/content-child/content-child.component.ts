...
<app-counter></app-counter>`;
    this.text2 = `ContentChild(selector: string | Function | Type<any>, opts?: {
  read?: any;
  static?: boolean;
}): any
}`;
    this.text3 = `import { Directive } from '@angular/core';
...
export class TabPanelContentDirective {
  constructor() { }
    ...
    this.text4 = `export class TabPanelComponent implements OnInit, OnDestroy {
  @Input() title: string;
  ...
  ngOnDestroy() {
    ...
    this.text5 = `<app-tab-panel title="Tab 1">
<ng-template tabPanelContent>
content tab 1
<app-counter></app-counter>
</ng-template>
</app-tab-panel>`;
    this.text6 = `@ContentChild(TabPanelContentDirective, {static: true, read: TemplateRef}) explicitBody: TemplateRef<unknown>;`;
    this.text7 = `export class TabPanelComponent implements OnInit, OnDestroy {
  @Input() title: string;
...
<app-counter></app-counter>`;
    this.text9 = `export class TabGroupComponent implements OnInit {
  ...
  selectItem(idx: number) {
    ...
    this.text10 = `export class TabPanelComponent {
  @Input() title: string;
  @ViewChild(TemplateRef, {static: true}) implicitBody: TemplateRef<unknown>;
  ...
  get panelBody(): TemplateRef<unknown> {
    ...
    this.text11 = `export class TabGroupComponent implements OnInit, AfterContentInit {
