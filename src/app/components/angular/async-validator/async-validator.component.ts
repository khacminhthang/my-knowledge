...
export class AsyncValidatorComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.text1 = `this.registerForm = this._fb.group({
  username: [
    "",
    Validators.compose([
      Validators.required,
  ...
  confirmPassword: [
    ...
    this.text2 = `<div class="container">
<form
  class="register-form"
...
>
  ...
  <pre>{{ registerForm.value | json }}</pre>
    ...
    this.text3 = `validateUsername(username: string): Observable<boolean> {
  ...
  return of(isValid).pipe(delay(1000));
    ...
    this.text4 = `validateUserNameFromAPI(
  ...
  return this._api.validateUsername(control.value).pipe(
    ...
    this.text5 = `this.registerForm = this._fb.group({
  username: [
    "",
    Validators.compose([
      Validators.required,
    ...
    this.text6 = `validateUserNameFromAPIDebounce(
  control: AbstractControl
): Observable<ValidationErrors | null> {
  return timer(300).pipe(
    ...
    this.text7 = `this.registerForm = this._fb.group({
  username: [
    "",
    Validators.compose([
      Validators.required,
...
></form>`;
    this.text10 = `validateControlsValue(firstControlName: string, secondControlName: string) {
  return function(formGroup: FormGroup) {
    ...
    this.text11 = `this.registerForm = this._fb.group(
  {
    password: [
      "",
      Validators.compose([
