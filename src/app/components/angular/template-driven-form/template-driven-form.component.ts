...
export class TemplateDrivenFormComponent implements OnInit {
    ...
    this.text2 = `const routes: Routes = [
  {
    ...
    this.text3 = `<div class="container">
<form class="sign-in-form">
  ...
  <div class="row-control row-actions">
    ...
    this.text4 = `import { MatInputModule } from '@angular/material/input';
...
export class AppModule {}`;
    this.text5 = `import { FormsModule } from '@angular/forms';
...
export class AppModule {}`;
    this.text6 = `<form novalidate #signInForm="ngForm" ...></form>`;
    this.text7 = `export class SignInComponent implements OnInit {
  constructor() {}
...
{{ signInForm.value | json }}
    ...
    this.text9 = `<input matInput placeholder="Username" ngModel />`;
    this.text10 = `Error: If ngModel is used within a form tag, either the name attribute must be set or the form control must be defined as 'standalone' in ngModelOptions.

Example 1: <input [(ngModel)]="person.firstName" name="first">
Example 2: <input [(ngModel)]="person.firstName" [ngModelOptions]="{standalone: true}">`;
    this.text11 = `<input matInput placeholder="Username" ngModel name="username" />`;
    this.text12 = `<form
class="sign-in-form"
novalidate
#signInForm="ngForm"
