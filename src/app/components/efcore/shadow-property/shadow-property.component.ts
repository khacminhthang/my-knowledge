    ...
    this.text1 = `public class Student
{
    ...
    this.text2 = `public class SchoolContext : DbContext
{
    ...
    this.text3 = `using (var context = new SchoolContext())
{
    ...
    this.text4 = `public override int SaveChanges()
{
    ...
    this.text5 = `using (var context = new SchoolContext())
{
    var std = new Student(){ StudentName = "Bill"  };
    context.Add(std);
    context.SaveChanges();
}`;
    this.text6 = `protected override void OnModelCreating(ModelBuilder modelBuilder)
{
