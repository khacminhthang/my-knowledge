...
export class FluentApiComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.text1 = `public class SchoolDBContext: DbContext
{
    ...
    this.text2 = `//Fluent API method chained calls
modelBuilder.Entity<Student>()
        .Property(s => s.StudentId)
        .HasColumnName("Id")
        .HasDefaultValue(0)
...
public class Grade
{
    ...
    this.text4 = `public class Student
{
...
public class Grade
{
    ...
    this.text5 = `public class Student
{
    public int Id { get; set; }
    public string Name { get; set; }
