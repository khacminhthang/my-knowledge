...
@Component({
  ...
  styleUrls: ['./stored-procedure.component.css']
})
export class StoredProcedureComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.text1 = `var context = new SchoolContext();

var students = context.Students
                  .FromSql("Select * from Students where Name = 'Bill'")
                  .ToList();`;
    this.text2 = `string name = "Bill";

var context = new SchoolContext();
var students = context.Students
                    .FromSql($"Select * from Students where Name = '{name}'")
                    .ToList();`;
    this.text3 = `string name = "Bill";

var context = new SchoolContext();
var students = context.Students
                    .FromSql("Select * from Students where Name = '{0}'", name)
                    .ToList();`;
    this.text4 = `exec sp_executesql N'Select * from Students where Name = ''@p0''
',N'@p0 nvarchar(4000)',@p0=N'Bill'
go`;
    this.text5 = `string name = "Bill";
...
var students = context.Students
                    ...
                    .ToList();`;
    this.text6 = `exec sp_executesql N'SELECT [s].[StudentId], [s].[Name]
FROM (
    Select * from Students where Name = ''@p0''
) AS [s]
ORDER BY [s].[StudentId]',N'@p0 nvarchar(4000)',@p0=N'Bill'
go`;
    this.text7 = `var context = new SchoolContext();
