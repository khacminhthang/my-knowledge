...
export class SavingDataComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.text1 = `private static void Main(string[] args)
{
...
public static string GetName() {
    ...
    this.text2 = `exec sp_executesql N'SELECT [s].[StudentId], [s].[DoB], [s].[FirstName],
[s].[GradeId], [s].[LastName], [s].[MiddleName]
FROM [Students] AS [s]
WHERE [s].[FirstName] = @__GetName_0',N'@__GetName_0 nvarchar(4000)',
@__GetName_0=N'Bill'
Go`;
    this.text3 = `var context = new SchoolContext();

var studentWithGrade = context.Students
                           .Where(s => s.FirstName == "Bill")
                           .Include(s => s.Grade)
                           .FirstOrDefault();`;
    this.text4 = `SELECT TOP(1) [s].[StudentId], [s].[DoB], [s].[FirstName], [s].[GradeId],[s].[LastName],
...
WHERE [s].[FirstName] = N'Bill'`;
    this.text5 = `var context = new SchoolContext();

var studentWithGrade = context.Students
                        .Where(s => s.FirstName == "Bill")
                        .Include("Grade")
                        .FirstOrDefault();`;
    this.text6 = `var context = new SchoolContext();
