...
export class InsertDataDisconnectedComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.text1 = `//Disconnected entity
...
using (var context = new SchoolContext())
{
    ...
    this.text2 = `exec sp_executesql N'SET NOCOUNT ON;
...
go`;
    this.text3 = `var stdAddress = new StudentAddress()
{
    City = "SFO",
    State = "CA",
    Country = "USA"
...
using (var context = new SchoolContext())
{
    ...
    this.text4 = `exec sp_executesql N'SET NOCOUNT ON;
INSERT INTO [Students] ([Name])
VALUES (@p0);
SELECT [StudentId]
FROM [Students]
...
Go`;
    this.text5 = `var studentList = new List<Student>() {
...
using (var context = new SchoolContext())
{
  ...
  context.SaveChanges();
    ...
    this.text6 = `var std1 = new Student(){ Name = "Bill" };
...
using (var context = new SchoolContext())
{
    ...
    this.text7 = `exec sp_executesql N'SET NOCOUNT ON;
...
go`;
    this.text8 = `var std = new Student()
{
    Name = "Bill"
};
