...
export class ChangeTrackerComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.text1 = `public static void Main()
{
...
private static void DisplayStates(IEnumerable<EntityEntry> entries)
{
    ...
    this.text2 = `using (var context = new SchoolContext())
{
    ...
    this.text4 = `using (var context = new SchoolContext())
{
    ...
    this.text5 = `var disconnectedEntity = new Student() { StudentId = 1, Name = "Bill" };

using (var context = new SchoolContext())
{
    Console.Write(context.Entry(disconnectedEntity).State);
}`;
    this.text6 = `public class Student
{
