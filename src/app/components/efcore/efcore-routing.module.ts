...
import { RawSqlComponent } from './raw-sql/raw-sql.component';
...
import { StoredProcedureComponent } from './stored-procedure/stored-procedure.component';
...
const efcoreRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'raw-sql',
        component: RawSqlComponent
      },
      {
        path: 'stored-procedure',
        component: StoredProcedureComponent
      },
      {
        path: 'logging',
