...
public class Course
{
    ...
    this.text2 = `public class StudentCourse
{
    public int StudentId { get; set; }
    ...
    this.text3 = `public class Student
{
    public int StudentId { get; set; }
    public string Name { get; set; }
...
public class Course
{
    ...
    public IList<StudentCourse> StudentCourses { get; set; }`;
    this.text4 = `public class SchoolContext : DbContext
{
    ...
    this.text5 = `modelBuilder.Entity<StudentCourse>().HasKey(sc => new { sc.SId, sc.CId });
