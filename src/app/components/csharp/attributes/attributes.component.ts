...
export class AttributesComponent implements OnInit {
  ...
  text1=`[attribute(positional_parameter, name_parameter = giá_trị, ...)]
element`
  text2=`[AttributeUsage(
 validon,
 AllowMultiple=allowmultiple,
 Inherited=inherited
)]`
  text3 = `[AttributeUsage(AttributeTargets.Class |
...
namespace Csharp
{
  ...
  text10 = `'Csharp.TestCsharp.PhuongThuc1()' is obsolete: 'Dung su dung PhuongThuc1, ban nen su dung PhuongThuc2'`
  text11 =`//a custom attribute BugFix to be assigned to a class and its members
...
public class DeBugInfo : System.Attribute`
  text12 = `//Vi du minh hoa mot custom attribute BugFix
[AttributeUsage(AttributeTargets.Class |
AttributeTargets.Constructor |
AttributeTargets.Field |
AttributeTargets.Method |
...
public class DeBugInfo : System.Attribute
{
  ...
  text13 = `[DeBugInfo(45, "Tran Nam", "2/8/2016", Message = "Kieu tra ve khong hop le")]
