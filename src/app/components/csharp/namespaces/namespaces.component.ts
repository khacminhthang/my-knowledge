...
export class NamespacesComponent implements OnInit {
  ...
  text1 = `namespace tên_namespace
{
  // phần khai báo code
}`
  text2 = `tên_namespace.tên_phần_tử;`
  text3 = `using System;
...
class TesCsharp
{
  ...
  text4 = `Console.WriteLine ("Hoc C# co ban va nang cao!!!");`
  text5 = `System.Console.WriteLine("Hoc C# co ban va nang cao!!!");`
  text6 = `using System;
...
class TesCsharp
{
  ...
  text7 = `namespace tên_namespace_1
{
  // phần khai báo code
