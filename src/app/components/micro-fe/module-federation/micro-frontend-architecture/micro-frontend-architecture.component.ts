...
export class MicroFrontendArchitectureComponent implements OnInit {
  ...
  text1 = `nx g @nx/angular:host shell --remotes=shop,cart
nx g @nx/angular:remote about --host=shell`
  text2 = `import { ModuleFederationConfig } from '@nx/webpack';
...
export default config;`
  text3 = `import { ModuleFederationConfig } from '@nx/webpack';
